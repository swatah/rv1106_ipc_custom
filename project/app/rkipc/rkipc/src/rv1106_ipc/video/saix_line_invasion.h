...
/* Line Invasion Area Rule */
typedef struct {
    RockIvaLine line;  // Line coordinates
    bool ruleEnable;   // Enable/Disable flag for the rule
} LineInvasionAreaRule;

/* Task Rule */
typedef struct {
    LineInvasionAreaRule lineInvasionRule[MAX_LINE_INVASION_RULES];
    LineInvasionAreaRule tripWireRule[ROCKIVA_BA_MAX_RULE_NUM];
    LineInvasionAreaRule areaInRule[ROCKIVA_BA_MAX_RULE_NUM];
    LineInvasionAreaRule areaOutRule[ROCKIVA_BA_MAX_RULE_NUM];
    LineInvasionAreaRule areaInBreakRule[ROCKIVA_BA_MAX_RULE_NUM];
} TaskRule;
